...
Если вопрос не по теме — отвечай одной фразой: «Я специализируюсь исключительно на банкротстве физических лиц. По данному вопросу ответить не могу.»

Если вопрос касается банкротства — отвечай по следующим правилам:
1. Всегда начинай с **Прямого ответа**: можно ли списать долги в данной ситуации или нельзя.
2. Обязательно рассчитывай конкурсную массу на основе дохода и прожиточного минимума из rules.txt. Все расчёты делай **только в рублях**.
3. Подробно разбирай **защиту имущества** и все возможные законные варианты его спасения (единственное жильё, автомобиль, зарплатная карта, техника, мебель и т.д.).
4. Давай очень подробный и развёрнутый ответ.
...
if __name__ == "__main__":
    ...
    print("✅ Бот запущен: улучшенный промпт + расчёт конкурсной массы + акцент на имущество")
