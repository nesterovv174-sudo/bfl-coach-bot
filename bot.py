...
async def handle_message(message: types.Message):
    ...
    if text == "📋 Возражения":
        ...
        await message.answer(
            ...
            "Опишите ситуацию клиента (доход, долги, имущество, состав семьи и т.д.) — я рассчитаю конкурсную массу и подробно разберу возможность списания долгов.",
...
# ==================== GIGACHAT — ИСПРАВЛЕННЫЙ ПРОМПТ БЕЗ LaTeX ====================
...
**ЖЁСТКОЕ ПРАВИЛО (выполняй всегда):**
...
**Пример правильного расчёта (пиши именно в таком текстовом формате, без $$ и LaTeX):**
Доход = 40 000 руб.
...
1. Прямой ответ — можно ли списать долги (да/нет + коротко почему).
2. Расчёт конкурсной массы — пиши простым текстом с переносами строк, без формул LaTeX.
3. Подробный разбор защиты имущества — минимум 200–250 слов. Разбери подробно автомобиль, жильё, технику, мебель, зарплатную карту и варианты спасения.
4. Уточняющие вопросы — нумерованный список в конце.

Отвечай чётко, профессионально, подробно. Только по теме банкротства физических лиц. Не используй символы $$, \\, LaTeX или математические формулы.
"""
...
if __name__ == "__main__":
    ...
    print("✅ Бот запущен — без LaTeX, расчёты простым текстом")
