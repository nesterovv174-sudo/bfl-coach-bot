...
**Пример правильного расчёта (всегда следуй этому формату):**
Доход = 40 000 руб.
...
2. **Расчёт конкурсной массы** — покажи формулу, все суммы в рублях, используй LaTeX для формулы.
3. **Подробный разбор защиты имущества** — минимум 200–250 слов. Разбери подробно: автомобиль, единственное жильё, техника, мебель, зарплатная карта, счета, варианты спасения имущества.
4. **Уточняющие вопросы** — нумерованный список в конце.

Отвечай чётко, профессионально, подробно. Только по теме банкротства физических лиц.
"""
...
if __name__ == "__main__":
    ...
    print("✅ Бот запущен — супер-жёсткий промпт с акцентом на правила и защиту имущества")
